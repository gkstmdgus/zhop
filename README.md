...
version by pointing at a release asset (replace `v0.2.0` with the tag you want):

```kdl
shared_except "locked" {
    bind "Ctrl y" {
        LaunchOrFocusPlugin "https://github.com/gkstmdgus/zhop/releases/download/v0.2.0/zhop.wasm" {
            floating true
            ignore_case true
        }
    }
